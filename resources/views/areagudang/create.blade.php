            ...
            <div class="card-body">
                <form action="{{ route('areagudang.store') }}" method="POST">
                        ...
                        <div class="col-md-6">
                            <select name="id_warehouse" id="" class="form-control">
                                ...
                                @foreach ($warehouse as $item => $nama_warehouse)
                                    <option value="{{ $nama_warehouse->id }}">{{ $nama_warehouse->nama_warehouse }}</option>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('nama_area') is-invalid @enderror" id="nama_area" name="nama_area" value="{{ old('nama_area') }}">
