...
@section('content')
    <div class="row">
        ...
        <div class="card h-100">
            ...
            <div class="gap-3 d-flex align-items-center mb-3">
        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                <div class="card-title d-flex justify-content-between align-items-start mb-4">
                    <div class="avatar flex-shrink-0">
                    <img src="{{ url('/') }}/assets/img/icons/unicons/cube-secondary.png" alt="cube" class="rounded" />
                    </div>
                    <div class="dropdown">
                    <button
                        class="btn p-0"
    ...
    <div class="row">
            ...
            <div class="col-md-6">
                ...
                <ul class="p-0 m-0">
                    ...
                    <div class="gap-2 d-flex flex-wrap justify-content-between align-items-center w-100">
                        ...
                        <small class="d-block text-muted mb-1">Oneplus</small>
                        </div>
                        <div class="user-progress gap-1 d-flex align-items-center">
                    ...
                    <li class="d-flex pb-1 mb-4">
                    <div class="avatar flex-shrink-0 me-3">
                        <img src="{{ url('/') }}/assets/img/icons/unicons/watch-primary.png" alt="smart band" />
                    </div>
                    <div class="gap-2 d-flex flex-wrap justify-content-between align-items-center w-100">
                        <div class="me-2">
                        <h6 class="mb-0">Smart Band 4</h6>
                        <small class="d-block text-muted mb-1">Xiaomi</small>
                        </div>
                        <div class="user-progress gap-1 d-flex align-items-center">
                    ...
                    <li class="d-flex pb-1 mb-4">
                    <div class="avatar flex-shrink-0 me-3">
                        <img src="{{ url('/') }}/assets/img/icons/unicons/surface.png" alt="Surface" />
                    </div>
                    <div class="gap-2 d-flex flex-wrap justify-content-between align-items-center w-100">
                        <div class="me-2">
                        <h6 class="mb-0">Surface Pro X</h6>
                        <small class="d-block text-muted mb-1">Miscrosoft</small>
                        </div>
                        <div class="user-progress gap-1 d-flex align-items-center">
                    ...
                    <div class="gap-2 d-flex flex-wrap justify-content-between align-items-center w-100">
                        ...
                        <small class="d-block text-muted mb-1">Apple</small>
                        </div>
                        <div class="user-progress gap-1 d-flex align-items-center">
                    ...
                    <div class="gap-2 d-flex flex-wrap justify-content-between align-items-center w-100">
                        ...
                        <small class="d-block text-muted mb-1">Beats</small>
                        </div>
                        <div class="user-progress gap-1 d-flex align-items-center">
            ...
            <div class="col-md-6">
                ...
                <ul class="p-0 m-0">
                    ...
                    <div class="gap-2 d-flex flex-wrap justify-content-between align-items-center w-100">
                        ...
                        <small class="d-block text-muted mb-1">HP</small>
                        </div>
                        <div class="user-progress gap-3 d-flex align-items-center">
                    ...
                    <div class="gap-2 d-flex flex-wrap justify-content-between align-items-center w-100">
                        ...
                        <small class="d-block text-muted mb-1">iMac Pro</small>
                        </div>
                        <div class="user-progress gap-3 d-flex align-items-center">
                    ...
                    <div class="gap-2 d-flex flex-wrap justify-content-between align-items-center w-100">
                        ...
                        <small class="d-block text-muted mb-1">Fitbit</small>
                        </div>
                        <div class="user-progress gap-3 d-flex align-items-center">
                    ...
                    <div class="gap-2 d-flex flex-wrap justify-content-between align-items-center w-100">
                        ...
                        <small class="d-block text-muted mb-1">Google</small>
                        </div>
                        <div class="user-progress gap-3 d-flex align-items-center">
        ...
        <div class="card h-100">
            ...
            <ul class="p-0 m-0">
                ...
                <li class="d-flex pb-1 mb-4">
                <div class="avatar flex-shrink-0 me-3">
                    <span class="avatar-initial bg-label-success rounded"><i class="bx bx-dollar"></i></span>
                </div>
                <div class="gap-2 d-flex flex-wrap justify-content-between align-items-center w-100">
                    <div class="me-2">
        ...
        <div class="card h-100">
            ...
            <ul class="p-0 m-0">
                <li class="d-flex pb-1 mb-4">
                <div class="avatar flex-shrink-0 me-3">
                    <img src="{{ url('/') }}/assets/svg/flags/us.svg" alt="User" class="rounded-circle" />
                </div>
                <div class="gap-2 d-flex flex-wrap justify-content-between align-items-center w-100">
                    <div class="me-2">
                    <div class="d-flex align-items-center">
                        <h6 class="me-1 mb-0">$8,567k</h6>
                ...
                <li class="d-flex pb-1 mb-4">
                <div class="avatar flex-shrink-0 me-3">
                    <img src="{{ url('/') }}/assets/svg/flags/br.svg" alt="User" class="rounded-circle" />
                </div>
                <div class="gap-2 d-flex flex-wrap justify-content-between align-items-center w-100">
                    <div class="me-2">
                    <div class="d-flex align-items-center">
                        <h6 class="me-1 mb-0">$2,415k</h6>
                ...
                <li class="d-flex pb-1 mb-4">
                <div class="avatar flex-shrink-0 me-3">
                    <img src="{{ url('/') }}/assets/svg/flags/in.svg" alt="User" class="rounded-circle" />
                </div>
                <div class="gap-2 d-flex flex-wrap justify-content-between align-items-center w-100">
                    <div class="me-2">
                    <div class="d-flex align-items-center">
                        <h6 class="me-1 mb-0">$865k</h6>
                        <small class="text-success fw-semibold">
                        <i class="bx bx-chevron-up"></i>
                        12.4%
                        </small>
                ...
                <li class="d-flex pb-1 mb-4">
                <div class="avatar flex-shrink-0 me-3">
                    <img src="{{ url('/') }}/assets/svg/flags/au.svg" alt="User" class="rounded-circle" />
                </div>
                <div class="gap-2 d-flex flex-wrap justify-content-between align-items-center w-100">
                    <div class="me-2">
                    <div class="d-flex align-items-center">
                        <h6 class="me-1 mb-0">$745k</h6>
                        <small class="text-danger fw-semibold">
                        <i class="bx bx-chevron-down"></i>
                        11.9%
                        </small>
                ...
                <li class="d-flex">
                <div class="avatar flex-shrink-0 me-3">
                    <img src="{{ url('/') }}/assets/svg/flags/fr.svg" alt="User" class="rounded-circle" />
                </div>
                <div class="gap-2 d-flex flex-wrap justify-content-between align-items-center w-100">
                    <div class="me-2">
                    <div class="d-flex align-items-center">
                        <h6 class="me-1 mb-0">$45</h6>
                        <small class="text-success fw-semibold">
                        <i class="bx bx-chevron-up"></i>
                        16.2%
                        </small>
        ...
        <div class="col-md-6 col-lg-4 mb-4">
        <div class="card h-100">
            <div class="card-header mb-30 d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex justify-content-around">
                <div class="lh-1 d-flex align-items-center mb-3 mb-sm-0">
            ...
            <table class="table table-borderless">
                ...
                <tr>
                    ...
                    <div class="d-flex justify-content-start align-items-center">
                        ...
                        <div class="d-flex flex-column">
                        <h6 class="text-truncate mb-0">Nathan Wagner</h6>
                        <small class="text-muted text-truncate">iOS Developer</small>
                        </div>
                    </div>
                    </td>
                ...
                <tr>
                    ...
                    <div class="d-flex justify-content-start align-items-center">
                        ...
                        <div class="d-flex flex-column">
                        <h6 class="text-truncate mb-0">Emma Bowen</h6>
                        <small class="text-muted text-truncate">UI/UX Designer</small>
                        </div>
                    </div>
                    </td>
                ...
                <tr>
                    ...
                    <div class="d-flex justify-content-start align-items-center">
                        <div class="avatar me-2">
                        <span class="avatar-initial bg-label-warning rounded-circle">AM</span>
                        </div>
                        <div class="d-flex flex-column">
                        <h6 class="text-truncate mb-0">Adrian McGuire</h6>
                        <small class="text-muted text-truncate">PHP Developer</small>
                        </div>
                    </div>
                    </td>
                ...
                <tr>
                    ...
                    <div class="d-flex justify-content-start align-items-center">
                        ...
                        <div class="d-flex flex-column">
                        <h6 class="text-truncate mb-0">Alma Gonzalez</h6>
                        <small class="text-muted text-truncate">Product Manager</small>
                        </div>
                    </div>
                    </td>
                ...
                <tr>
                    ...
                    <div class="d-flex justify-content-start align-items-center">
                        ...
                        <div class="d-flex flex-column">
                        <h6 class="text-truncate mb-0">Allan kristian</h6>
                        <small class="text-muted text-truncate">Frontend Designer</small>
                        </div>
                    </div>
                    </td>
            ...
            <table class="invoice-list-table table border-top">
                ...
                <tr>
                    ...
                    <div class="d-flex justify-content-start align-items-center">
                        ...
                        <div class="d-flex flex-column">
                        <a href="pages-profile-user.html" class="text-body fw-semibold text-truncate"
                            >Henry Barnes</a
                        >
                        <small class="text-muted text-truncate">jok@puc.co.uk</small>
                        </div>
                    </div>
                    </td>
                    <td>$459.65</td>
                ...
                <tr>
                    ...
                    <div class="d-flex justify-content-start align-items-center">
                        ...
                        <a href="pages-profile-user.html" class="text-body fw-semibold text-truncate"
                            >Hallie Warner</a
                        >
                        <small class="text-muted text-truncate">hellie@war.co.uk</small>
                        </div>
                    </div>
                    </td>
                    <td>$93.81</td>
                ...
                <tr>
                    ...
                    <div class="d-flex justify-content-start align-items-center">
                        ...
                        <a href="pages-profile-user.html" class="text-body fw-semibold text-truncate"
                            >Gerald Flowers</a
                        >
                        <small class="text-muted text-truncate">initus@odemi.com</small>
                        </div>
                    </div>
                    </td>
                    <td>$934.35</td>
                ...
                <tr>
                    ...
                    <div class="d-flex justify-content-start align-items-center">
                        ...
                        <a href="pages-profile-user.html" class="text-body fw-semibold text-truncate"
                            >John Davidson</a
                        >
                        <small class="text-muted text-truncate">jtum@upkesja.gov</small>
                        </div>
                    </div>
                    </td>
                    <td>$794.97</td>
                ...
                <tr>
                    ...
                    <div class="d-flex justify-content-start align-items-center">
                        <div class="avatar-wrapper">
                        <div class="avatar avatar-sm me-2">
                            <span class="avatar-initial bg-label-warning rounded-circle">JH</span>
                        </div>
                        </div>
                        <div class="d-flex flex-column">
                        <a href="pages-profile-user.html" class="text-body fw-semibold text-truncate"
                            >Jayden Harris</a
                        >
                        <small class="text-muted text-truncate">wipare@tin.com</small>
                        </div>
                    </div>
                    </td>
                    <td>$19.49</td>
                ...
                <tr>
                    ...
                    <div class="d-flex justify-content-start align-items-center">
                        ...
                        <a href="pages-profile-user.html" class="text-body fw-semibold text-truncate"
                            >Rena Ferguson</a
                        >
                        <small class="text-muted text-truncate">nur@kaomor.edu</small>
                        </div>
                    </div>
                    </td>
                    <td>$636.27</td>
