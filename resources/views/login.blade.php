                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('login.custom') }}">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="email" name="email" placeholder="Eamil" @error('email') is-invalid @enderror value="prama680@gmail.com" />
                            ...
                            <div class="form-floating mb-3">
                                <input type="password" class="form-control" id="password" name="password" placeholder="password" @error('password') is-invalid @enderror value="123456789" />
                        ...
                        <div class="text-center mt-3">
                            <a class="text-size-6" href="{{ route('register-user') }}">Dont have account ? Signt Up Now!</a>
                        </div>
                    </div>
                </div>
            </div>
